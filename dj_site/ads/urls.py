...
urlpatterns = [
    ...
    path('ad/create', views.PicCreateView.as_view(success_url=reverse_lazy('ads:all')), name='ad_create'),
    path('ad/<int:pk>/update', views.PicUpdateView.as_view(success_url=reverse_lazy('ads:all')), name='ad_update'),
